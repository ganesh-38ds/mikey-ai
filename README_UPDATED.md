...
* **SQLite3:** Lightweight, local database for managing users, chats, and analytics.
...
## 🚀 How to Run Locally
1. **Clone the repository:** `git clone https://github.com/ganesh-38ds/shadowcall-ai.git`
